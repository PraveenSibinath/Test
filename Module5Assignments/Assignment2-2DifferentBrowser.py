...
def test_facebook_registration_page_using_chrome(setup_browser):
    ...
    driver.find_element(by=By.XPATH, value='//*[@id="email"]').send_keys("npraveen0504@gmail.com")
    driver.find_element(by=By.XPATH, value='//*[@id="pass"]').send_keys("Praveen0504!")
    driver.find_element(by=By.XPATH, value='//*[@data-testid="royal_login_button"]').click()
